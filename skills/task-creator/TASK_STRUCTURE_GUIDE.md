...
1. Create project folder: `.agent-tasks/tasks/[YYYYMMDD-task-folder]/`
...
**Steps:**
1. Create `.agent-tasks/archive/` if it doesn't exist
2. Move project folder to `archive/[YYYYMMDD-task-folder]/`
...
### Create New Project
```bash
mkdir -p .agent-tasks/tasks/[YYYYMMDD-task-folder]/{research,pending,in-progress,complete,testing}
touch .agent-tasks/tasks/[YYYYMMDD-task-folder]/ORCHESTRATOR.md
```
...
mv .agent-tasks/tasks/[YYYYMMDD-task-folder] .agent-tasks/archive/[YYYYMMDD-task-folder]
