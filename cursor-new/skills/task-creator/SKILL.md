...
- `.cursor/TASK_STRUCTURE_GUIDE.md` — Folder conventions and project layout
- `.cursor/TASK_CREATION_GUIDE.md` — Task file format and writing rules
...
2. Create task file: `.cursor/tasks/[project]/pending/XXX-[action]-[subject].md`
...
- Source: .cursor/tasks/facebook-api-v24-upgrade-20260130/research/facebook-api-upgrade-guide.md
```
